...
class MainRenderer:
    ...
    def _draw_live_mlb(self, game):
        ...
        if not game['1b'] and not game['2b'] and not game['3b']:
            bases = Image.open('logos/scoreboard/Bases_0.png').resize((24, 18), Image.BOX)
        elif game['1b'] and not game['2b'] and not game['3b']:
            bases = Image.open('logos/scoreboard/Bases_1.png').resize((24, 18), Image.BOX)
        elif not game['1b'] and game['2b'] and not game['3b']:
            bases = Image.open('logos/scoreboard/Bases_2.png').resize((24, 18), Image.BOX)
        elif not game['1b'] and not game['2b'] and  game['3b']:
            bases = Image.open('logos/scoreboard/Bases_2.png').resize((24, 18), Image.BOX)
        elif game['1b'] and game['2b'] and not game['3b']:
            bases = Image.open('logos/scoreboard/Bases_12.png').resize((24, 18), Image.BOX)
        elif game['1b'] and not game['2b'] and game['3b']:
            bases = Image.open('logos/scoreboard/Bases_13.png').resize((24, 18), Image.BOX)
        elif not game['1b'] and game['2b'] and game['3b']:
            bases = Image.open('logos/scoreboard/Bases_23.png').resize((24, 18), Image.BOX)
        elif game['1b'] and game['2b'] and game['3b']:
            bases = Image.open('logos/scoreboard/Bases_123.png').resize((24, 18), Image.BOX)
        elif game['1b'] and not game['2b'] and game['3b']:
            bases = Image.open('logos/scoreboard/Bases_13.png').resize((24, 18), Image.BOX)
        else:
            bases = Image.open('logos/scoreboard/Bases_0.png').resize((24, 18), Image.BOX)
